...
insert into categories(name) values ('edition');
...
insert into user_type(type) values ('libraries'),('publishers'),('candidates'),('librarians');
...
insert into gender (gender_type) values('Male'),('Female'),('others');
...
-- cities
select city_id,city,state from cities as c inner join states as s where c.state_id=s.state_id;

-- users
insert into users (name,email,password,city_id,contact,address,gender_id,user_type_id) values(?,?,?,?,?,?,?,?);
UPDATE users SET verification_code = NULL, status_id = 8 WHERE email = '7509424731aa@gmail.com' AND verification_code = '1716986043592_3767374546985176456';
select password,user_id,u.name,u.gender_id,dob,c.city_id,c.city,s.state_id,s.state,address,contact,profile_pic,status_id from users as u inner join cities as c inner join states as s where c.state_id = s.state_id and u.city_id = c.city_id and email = '7509424731aa@gmail.com' ;
insert into users (name,email,password,city_id,contact,address,gender_id,user_type_id) values('sumit','sumit@gmail','12213',1,'750942741','pnb',1,1);
...
--books
insert into books(isbn_no,title,category_id,published_id);
insert into books (book_pic) value(?) where book_id=?;
select book_id,title,c.category_id,name from books as b inner join categories as c where b.category_id=c.category_id and publisher_id = ?;
...
-- 
select u.profile_pic,u.name,current_dues,be.book_edition_id 
from memberships m 
join users u 
