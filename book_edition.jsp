                ...
                <div class="col">
                    <div data-bs-toggle="tab" data-bs-target="#book_edition_pane">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <a class="btn btn-outline-primary" href="book_edition.do?book_id=${param.book_id}&num=1">Show Editions</a>
                            </div>
                        ...
                        <div class="tab-pane fade show active" id="book_edition_pane">
                            ...
                            <c:forEach var="edition" items="${book_editions}" varStatus="n">
                                ...
                                <div class="col-md mt-4">
                                    <a data-bs-target="#edition_image" data-bs-toggle="modal" class="edition_book" id="${edition.bookEditionId}">
                                        <div class="card shadow p-3 mb-5 bg-body-tertiary rounded" style="width:15rem;">

                                            <c:choose>
                                                <c:when test="${empty edition.bookEditionPic}">
                                                    <img src="static/media/images/book.png" class="card-img-top" width="100" height="250">
                                                </c:when>
                                                <c:otherwise>
                                                    <img src="show_edition_img.do?path=${edition.bookEditionPic}" width="100" height="250" class="card-img-top">
                                                </c:otherwise>
                                            </c:choose>
                                    </a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <a href="delete_book_edition.do?book_id=${param.book_id}&book_edition_id=${edition.bookEditionId}">
                                                        <img src="static/media/images/delete.png" width="35">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <a href="update_book_edition.do?book_edition_id=${edition.bookEditionId}">
